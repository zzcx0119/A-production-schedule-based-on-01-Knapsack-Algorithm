...
最后会输出两个txt文件，分别是每一道次的安排(图片中的内容)epoch.txt与正式表格中的内容arrangement.txt（~~因为c++输出的局限性，所以需要把txt文件翻转180度在转置一下就是表格的内容😣~~），这些内容与代码在文件里面都能看到，下面让我讲一下我的排产与真实数据的差异与理由
...
以上看法只是个人见解，同时从这次大作业我学到了大项目的构建思路，与算法的设计思路，为我之后的学习提供了很大帮助，之后如果有项目我也会放在github，以供参考
