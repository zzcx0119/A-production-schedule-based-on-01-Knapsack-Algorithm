...
void paichan::getprice(int n)
{
    for (int i = 0; i < n; i++)
    {
        if (bricks[i].type[3] == 'R' && bricks[i].left_number <= 0)
        {
            bricks[i - 1].flag = 1;
        }
    }
